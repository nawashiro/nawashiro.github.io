...
<a class="card md:card-side my-4 bg-white shadow-sm" href="https://yahoo.jp/gXG96Z">
  <figure class="px-5 py-5">
    <img
      src="https://item-shopping.c.yimg.jp/i/n/tower_6331907_i_20251112223245"
      alt="Book"
      class="rounded-xl max-h-48 max-w-48 object-contain" />
  </figure>
  <div class="card-body">
    <span class="badge badge-primary">広告</span>
    <span class="card-title line-clamp-1">劉慈欣 三体3 死神永生 下 Book</span>
  </div>
</a>
