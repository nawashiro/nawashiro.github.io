...
しかし、だからといって、私たちには全く選択の自由がないわけではありません。私たちは、社会的な相互作用を通じて、自分の行動を抑制したり、変更したりすることができます。

また、方向づけというあいまいな表現を使ったのにも意味があります。現代の物理学では、複雑系・カオス理論・不確定性原理などにより、決定論はほぼ否定されているため、ある状態がある状態を 100% 引き起こすとは言えないのです。
