...
<a class="card md:card-side my-4 bg-white shadow-sm" href="https://yahoo.jp/7FnAz4">

  <figure class="px-5 py-5">
    <img
      src="https://item-shopping.c.yimg.jp/i/n/hmv_7097044"
      alt="Book"
      class="rounded-xl max-h-48 max-w-48 object-contain" />
  </figure>
  <div class="card-body">
    <span class="badge badge-primary">広告</span>
    <span class="card-title line-clamp-1">思い出す事など / 私の個人主義 / 硝子戸の中 講談社文芸文庫 / 夏目漱石 ナツメソウセキ 〔文庫〕</span>
...
<a class="card md:card-side my-4 bg-white shadow-sm" href="https://yahoo.jp/mWR4aZ">

  <figure class="px-5 py-5">
    <img
      src="https://item-shopping.c.yimg.jp/i/n/ebookjapan_b00160655847_i_20250428234309"
      alt="Book"
      class="rounded-xl max-h-48 max-w-48 object-contain" />
  </figure>
  <div class="card-body">
    <span class="badge badge-primary">広告</span>
    <span class="card-title line-clamp-1">家康、江戸を建てる 電子書籍版 / 門井慶喜</span>
    
  </div>
</a>

<a class="card md:card-side my-4 bg-white shadow-sm" href="https://yahoo.jp/y4h_BL">

  <figure class="px-5 py-5">
    <img
      src="https://item-shopping.c.yimg.jp/i/n/bookfan_bk-4000298569_i_20250111142703"
      alt="Book"
      class="rounded-xl max-h-48 max-w-48 object-contain" />
  </figure>
  <div class="card-body">
    <span class="badge badge-primary">広告</span>
    <span class="card-title line-clamp-1">岩波データサイエンス Vol.6/岩波データサイエンス刊行委員会</span>
  </div>
</a>
