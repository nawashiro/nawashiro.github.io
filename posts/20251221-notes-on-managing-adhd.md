...
![要約のポンチ絵。第1層：薬物療法はすべての基盤。第2層：To-Doリストを外部脳として使う。一日のうち最もエネルギーのある時間（朝など）にタスクを組み込む。第3層：To-Doリストを常に視界に。プロジェクトとの接触を保つ。スマホの通知などの割り込みはやめて定期確認に。](20251221-eQc4Vo2.webp)
