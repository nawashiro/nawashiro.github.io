...
date: "2024-12-17"
---
   <a class="card md:card-side my-4 bg-white shadow-sm" href="https://yahoo.jp/skgU5c">
   <figure class="px-5 py-5">
     <img
       src="https://item-shopping.c.yimg.jp/i/n/vaboo_va0206210415u30"
       alt="Book"
       class="rounded-xl max-h-48 max-w-48 object-contain" />
   </figure>
   <div class="card-body">
    <span class="badge badge-primary">広告</span>
     <span class="card-title line-clamp-1">三体 ３ 上/早川書房/劉慈欣（単行本） 中古</span>
  </div>
</a>
