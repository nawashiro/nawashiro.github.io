...
手作業で修正していきます。機関ひとつひとつの存在を確かめたり、区のオープンデータと突き合わせたり、分類が妥当か確かめたりしました。最初は区内の喫茶店を独断と偏見で載せたりして見ようと思っていたのですが、追跡が大変なことに気づいてやめました。
...
というわけで、公共図書館の写真をコンプリートする旅に出かけることにしました。決めたはいいものの、肝心の中央図書館が難所でした。合同庁舎のなかにあるので、中に入り込んで写真を撮る必要があったのです。すると話がややこしくなってきます。他の利用者もいますし、蔵書もあるからです。
...
というわけで [Code for Chiyoda](https://github.com/code4chiyoda/) を立ち上げました。千代田区に住んでいなくても全く問題ありません。近いうちに準備会のチャットを作ると思うので、その時は是非来てください。
