...
<a class="card md:card-side my-4 bg-white shadow-sm" href="https://yahoo.jp/YEYm5A">
  <figure class="px-5 py-5">
    <img
      src="https://item-shopping.c.yimg.jp/i/n/kinokuniya_9784799105689"
      alt="Book"
      class="rounded-xl max-h-48 max-w-48 object-contain" />
  </figure>
  <div class="card-body">
    <span class="badge badge-primary">広告</span>
    <span class="card-title line-clamp-1">折れない心のつくりかた―はじめてのレジリエンスワークブック</span>
  </div>
</a>
