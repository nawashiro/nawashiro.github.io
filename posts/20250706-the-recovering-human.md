...
<a class="card md:card-side my-4 bg-white shadow-sm" href="https://yahoo.jp/BGNmme">
  <figure class="px-5 py-5">
    <img
      src="https://item-shopping.c.yimg.jp/i/n/bookfan_bk-4560090599_i_20260206164427"
      alt="Book"
      class="rounded-xl max-h-48 max-w-48 object-contain" />
  </figure>
  <div class="card-body">
    <span class="badge badge-primary">広告</span>
    <span class="card-title line-clamp-1">回復する人間/ハンガン/斎藤真理子</span>
  </div>
</a>
